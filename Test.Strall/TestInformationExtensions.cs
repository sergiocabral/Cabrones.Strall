...
namespace Strall
{
    public class TestInformationExtensions: IDisposable
    {
        ...
        public void verificações_declarativas()
        {
            ...
            sut.AssertMyOwnPublicMethodsCount(18);
            ...
            sut.AssertPublicMethodPresence("IInformation GetInformation(Guid, Boolean = 'True')");
            sut.AssertPublicMethodPresence("IInformation Get(IInformation, Boolean = 'True')");
            sut.AssertPublicMethodPresence("IInformation Create(IInformation, Boolean = 'True')");
            sut.AssertPublicMethodPresence("Boolean Update(IInformation, Boolean = 'True')");
            sut.AssertPublicMethodPresence("IInformation UpdateOrCreate(IInformation, Boolean = 'True')");
            ...
            sut.AssertPublicMethodPresence("IInformation ContentLoad(IInformation, Boolean = 'True')");
            sut.AssertPublicMethodPresence("IInformation ContentSave(IInformation, Boolean = 'True')");
